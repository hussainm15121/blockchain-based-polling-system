...
const PollCard = ({ sender, pollId, title, category, description, options, votes, timestamp, start, end, VhasVoted }) => {
    ...
    return (
      ...
      <div className="content-polls">
        ...
        <button onClick={onClick} className='vote-but'> Click to view the voters! </button>        
  ...
  const EndedPoll = () => {
    ...
    return (
      ...
      <div class="float-child">
        ...
        <div class="content">
          <div class="con-Title">
          {currentAccount ? (<div className="con-Title">ENDED POLLS<br/><input class="searchPoll" placeholder="Search for polls..." 
